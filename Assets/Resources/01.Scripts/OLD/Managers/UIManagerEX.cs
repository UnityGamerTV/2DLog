...
public class UIManagerEX
{
    ...
    public T MakeSubItme<T>(Transform parent = null, string name = null) where T : UI_BaseEX
    {
    ...
    public T ShowSceneUI<T>(string name = null) where T : UI_SceneEX
    {
        if (string.IsNullOrEmpty(name))
            name = typeof(T).Name;
    ...
    public void ClosePopupUI(UI_PopupEX popup)
    {
